# DividerBlock, ColumnListBlock, ColumnBlock, BasicBlock, TodoBlock, CodeBlock, FactoryBlock, HeaderBlock, SubheaderBlock, PageBlock, BulletedListBlock, NumberedListBlock, ToggleBlock, QuoteBlock, TextBlock, EquationBlock, MediaBlock, EmbedBlock, EmbedOrUploadBlock, VideoBlock, FileBlock, AudioBlock, PDFBlock, ImageBlock, BookmarkBlock, LinkToCollectionBlock, BreadcrumbBlock, CollectionViewBlock, CollectionViewPageBlock, FramerBlock, TweetBlock, GistBlock, DriveBlock, FigmaBlock, LoomBlock, TypeformBlock, CodepenBlock, MapsBlock, InvisionBlock
...
def run_live_smoke_test(token_v2, parent_page_url_or_id):
    ...
    collection = client.get_collection(client.create_record("collection", parent=cvb, schema=collection_schema))

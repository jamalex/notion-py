...
if __name__ == "__main__":
    ...
    parser.add_argument("--page", dest="page", help="page URL or ID", required=True, type=str)
    ...
    if not token:
        print("Must either pass --token option or set NOTION_TOKEN environment variable")
        sys.exit(1)
